...
#   FFLAGS =  -O1    -u       # DEBUG=1  (basic DEBUG option)
...
#
OBJECTS = dpotfit.o masses.o readata.o tvsort.o readpot.o writepot.o vgen.o dampF.o AFdiag.o mkpredict.o dyidpj.o dvirdp.o vgenp.o diffstats.o prepott.o mappar.o alf.o scecor.o cdjoel.o schrq.o nllssrr.o fununc.o gpround.o PSfunc.o uncbv.o dpsidp.o 
