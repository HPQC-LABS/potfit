      real*8 rr,vv,dVdR,d2VdR2,RH,RMIN,RMAX
      integer I
      READ(5,*)  RH,RMIN,RMAX

      call VGENmlr(-1.d0,VDIST,dVdR,d2VdR2)

      RR= RMIN - RH
      DO  I=1,10000
          RR= RR+RH
          call VGENmlr(RR,VV,dVdR,d2VdR2)
          write(6,601) RR,VV,dVdR,d2VdR2
          IF(RR.GE.RMAX) GOTO 99
          ENDDO
   99 STOP
  601 FORMAT(f8.3,1PD17.8,3d17.8)          
      END
